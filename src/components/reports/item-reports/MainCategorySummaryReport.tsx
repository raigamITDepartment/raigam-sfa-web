...
import { getMainCategorySummery } from '@/services/reports/otherReportsApi'
...
const isMainCategoryIdKey = (key: string) =>
  ['maincatid', 'maincategoryid'].includes(normalizeKey(key))
...
const MainCategorySummaryReport = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ['reports', 'main-category-summary', queryParams],
    enabled: canFetch,
    queryFn: () => getMainCategorySummery(queryParams!),
  })
                  ...
                  <DataTableToolbar
                    ...
                    rightContent={
                      <ExcelExportButton
                        ...
                        fileName='main-category-summary-report'
                        worksheetName='Main Category Summary Report'
                      >
                      ...
                      <TableRow key={headerGroup.id}>
                        ...
                        <TableHead
                          ...
                          className={cn(
                            ...
                            isMainCategoryIdKey(String(header.column.id)) &&
                              'pl-3'
                          )}
                        >
                          ...
                          {row.getVisibleCells().map((cell, cellIndex) => (
                            <TableCell
                              ...
                              className={cn(
                                ...
                                isMainCategoryIdKey(String(cell.column.id)) &&
                                  'pl-3'
                              )}
                            >
