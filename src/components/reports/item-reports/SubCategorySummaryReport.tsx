...
import { getSubCategorySummery } from '@/services/reports/otherReportsApi'
...
const SHORT_HEADER_MAP: Record<string, string> = {
  subonecatid: 'Sub1 ID',
  subonecategoryid: 'Sub1 ID',
  sub1catid: 'Sub1 ID',
  sub1categoryid: 'Sub1 ID',
  subonecatname: 'Sub1 Cat',
  subonecategoryname: 'Sub1 Cat',
  sub1catname: 'Sub1 Cat',
  sub1categoryname: 'Sub1 Cat',
...
const isSubOneCategoryIdKey = (key: string) =>
  [
    'subonecatid',
    'subonecategoryid',
    'sub1catid',
...
const SubCategorySummaryReport = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ['reports', 'sub-category-summary', queryParams],
    enabled: canFetch,
    queryFn: () => getSubCategorySummery(queryParams!),
  })
                  ...
                  <DataTableToolbar
                    ...
                    rightContent={
                      <ExcelExportButton
                        ...
                        fileName='sub-category-summary-report'
                        worksheetName='Sub Category Summary Report'
                      >
                      ...
                      <TableRow key={headerGroup.id}>
                        ...
                        <TableHead
                          ...
                          className={cn(
                            ...
                            isSubOneCategoryIdKey(String(header.column.id)) &&
                              'pl-3'
                          )}
                        >
                          ...
                          {row.getVisibleCells().map((cell, cellIndex) => (
                            <TableCell
                              ...
                              className={cn(
                                ...
                                isSubOneCategoryIdKey(String(cell.column.id)) &&
                                  'pl-3'
                              )}
                            >
