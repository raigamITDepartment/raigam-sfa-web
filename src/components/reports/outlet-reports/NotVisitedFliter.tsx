...
type NotVisitedFilterProps = {
  initialValues?: NotVisitedFilters
  onApply?: (filters: NotVisitedFilters) => void
  onReset?: () => void
}
...
export default function NotVisitedFliter({
  initialValues,
  onApply,
  onReset,
  ...
  const { data: channels = [], isLoading: loadingChannels } = useQuery({
    queryKey: ['reports', 'outlet-reports', 'not-visited', 'channels'],
    ...
    onApply?.({
      subChannelId: isSubChannelLocked
        ...
        : resetSubChannelId
          ...
          : undefined,
      areaId: resetAreaId ? toNumberValue(resetAreaId) ?? 0 : 0,
